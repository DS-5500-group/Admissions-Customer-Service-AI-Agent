...
class BamlAsyncClient:
    ...
    async def AnswerQuery(self, question: str,context: str,
        baml_options: BamlCallOptions = {},
    ) -> str:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            __stream__ = self.stream.AnswerQuery(question=question,context=context,
                baml_options=baml_options)
            return await __stream__.get_final_response()
        else:
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="AnswerQuery", args={
    ...
    async def ParseQuery(self, question: str,
        baml_options: BamlCallOptions = {},
    ) -> types.ClassifiedQuestion:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            __stream__ = self.stream.ParseQuery(question=question,
                baml_options=baml_options)
            return await __stream__.get_final_response()
        else:
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="ParseQuery", args={
                "question": question,
            })
            return typing.cast(types.ClassifiedQuestion, __result__.cast_to(types, types, stream_types, False, __runtime__))
...
class BamlStreamClient:
    ...
    def AnswerQuery(self, question: str,context: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[str, str]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="AnswerQuery", args={
            "question": question,"context": context,
        })
    ...
    def ParseQuery(self, question: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.ClassifiedQuestion, types.ClassifiedQuestion]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="ParseQuery", args={
            "question": question,
        })
        return baml_py.BamlStream[stream_types.ClassifiedQuestion, types.ClassifiedQuestion](
          __result__,
          lambda x: typing.cast(stream_types.ClassifiedQuestion, x.cast_to(types, types, stream_types, True, __runtime__)),
          lambda x: typing.cast(types.ClassifiedQuestion, x.cast_to(types, types, stream_types, False, __runtime__)),
          __ctx__,
        )
...
class BamlHttpRequestClient:
    ...
    async def AnswerQuery(self, question: str,context: str,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="AnswerQuery", args={
            "question": question,"context": context,
        }, mode="request")
        return __result__
    async def ExtractResume(self, resume: str,
    ...
    async def ParseQuery(self, question: str,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ParseQuery", args={
            "question": question,
        }, mode="request")
        return __result__
