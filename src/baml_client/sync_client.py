...
class BamlSyncClient:
    ...
    def AnswerQuery(self, question: str,context: str,
        ...
        if 'on_tick' in baml_options:
            ...
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="AnswerQuery", args={
    ...
    def ParseQuery(self, question: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="ParseQuery", args={
                "question": question,
            })
...
class BamlStreamClient:
    ...
    def AnswerQuery(self, question: str,context: str,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="AnswerQuery", args={
            "question": question,"context": context,
        })
    ...
    def ParseQuery(self, question: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.ClassifiedQuestion, types.ClassifiedQuestion]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="ParseQuery", args={
            "question": question,
        })
        return baml_py.BamlSyncStream[stream_types.ClassifiedQuestion, types.ClassifiedQuestion](
          __result__,
...
class BamlHttpRequestClient:
    ...
    def AnswerQuery(self, question: str,context: str,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="AnswerQuery", args={
            "question": question,"context": context,
        }, mode="request")
        return __result__
    def ExtractResume(self, resume: str,
    ...
    def ParseQuery(self, question: str,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ParseQuery", args={
            "question": question,
        }, mode="request")
        return __result__
